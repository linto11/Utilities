...
namespace Com.Utility.Collection
{
    ...
    /// CachHelper is thread safe and will delete expired entries on its own using System.Threading.Timers (which run on <see cref="ThreadPool"/> threads).
    /// </summary>
    public class CacheHelper<K, T> : IDisposable
    {
        #region Constructor and class members

        /// <summary>
        /// Initializes a new instance of the <see cref="CacheHelper{K,T}"/> class.
        /// </summary>
        public CacheHelper() { }
        ...
        #endregion Constructor and class members
        ...
        #endregion IDisposable implementation & Clear
        ...
        #endregion AddOrUpdate, Get, Remove, Exists, Clear
    }

    #endregion CachHelper<T> class

    #region Other CachHelper classes (derived)
    ...
    /// CachHelper is thread safe and will delete expired entries on its own using System.Threading.Timers (which run on <see cref="ThreadPool"/> threads).
    /// </summary>
    public class CachHelper<T> : CacheHelper<string, T>
    {
    }

    /// <summary>
    /// The non-generic CachHelper class instanciates a CachHelper{object} that can be used with any type of (mixed) contents.
    ...
    /// </summary>
    public class CachHelper : CacheHelper<string, object>
    {
        #region Static Global CachHelper instance

        private static Lazy<CachHelper> global = new Lazy<CachHelper>();
        ...
        /// </value>
        public static CachHelper Global => global.Value;

        #endregion Static Global CachHelper instance
    }

    #endregion Other CachHelper classes (derived)
}